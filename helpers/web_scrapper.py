...
class WebScraper:
    ...
    def scrape_html_from_url(self, category: str, url: str, page: int = 1, offset: int = 0) -> BeautifulSoup:
        ...
        for article in articles:
            ...
            article_title = article.find("h3", class_="node-title").text.strip().replace("\n", "")
